...
*/
        ...
        {
            moveTouch.mainButton.rectTransform.position = new 
                Vector3(moveTouch.currentTouchPos.x 
                - moveTouch.touchOffset.x, moveTouch.currentTouchPos.y 
                - moveTouch.touchOffset.y);
